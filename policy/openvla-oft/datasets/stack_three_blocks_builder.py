...
class aloha_stack_three_blocks(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        train_files = glob.glob(
            "/root/autodl-tmp/Robotwin-dataset/Stack_Three_Blocks/preprocessed_dataset/train/*.hdf5"
        )
        val_files = glob.glob(
            "/root/autodl-tmp/Robotwin-dataset/Stack_Three_Blocks/preprocessed_dataset/val/*.hdf5"
        )
...
if __name__ == "__main__":
    builder = aloha_stack_three_blocks()
